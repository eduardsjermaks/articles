...
- Maintainability metrics flag hard-to-change code — but can on-call engineer debug it at 3 a.m.?
...
Those answers could be captured in shared recipes — per-tier evidence requirements — as deployment checklists once were.
